...
function dodel(funId){//点击删除调用js函数,传入会员号
	if(confirm("是否删除？")){
		location.href="${pageContext.request.contextPath}/fun/delete?funId="+funId;
	}
}
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[功能管理]-[功能查看]</td>
              </tr>
            </table></td>
              ...
              <tr>
                ...
                <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center"><A href="${pageContext.request.contextPath}/to/admin/funs/save">新增</A></div></td>
                  </tr>
                </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <form action="${pageContext.request.contextPath}/fun/list" name="searchForm" method="post">
        <!--带页号-->
         <input type="hidden" name="pageNum" value="1"/>
		名称：<input name="funName" type="text" value="${keyFun.funName}" size="16">
		Target：<input name="funTarget" type="text" value="${keyFun.funTarget}" size="20">
		 Level： <select name="funLevel" id="select">
			<option value="">全部</option>
			<option value="1"
                    <c:if test="${keyFun.funLevel==1}">selected</c:if>
            >1</option>
            <option value="2"
                    <c:if test="${keyFun.funLevel==2}">selected</c:if>
            >2</option>
		</select>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="5%" height="19" background="images/bg.gif" bgcolor="#FFFFFF" nowrap="nowrap"><div align="center"><span class="STYLE1">名称</span></div></td>
            <td width="5%" height="19" background="images/bg.gif" bgcolor="#FFFFFF" nowrap="nowrap"><div align="center"><span class="STYLE1">URL</span></div></td>
            <td width="5%" height="19" background="images/bg.gif" bgcolor="#FFFFFF" nowrap="nowrap"><div align="center"><span class="STYLE1">Pid</span></div></td>
            <td width="30%" height="19" background="images/bg.gif" bgcolor="#FFFFFF" nowrap="nowrap"><div align="center"><span class="STYLE1">Target</span></div></td>
            <td width="10%" height="19" background="images/bg.gif" bgcolor="#FFFFFF" nowrap="nowrap"><div align="center"><span class="STYLE1">Sort</span></div></td>
            <td width="10%" height="19" background="images/bg.gif" bgcolor="#FFFFFF" nowrap="nowrap"><div align="center"><span class="STYLE1">Level</span></div></td>
          ...
          <tr>
            ...
            <td height="20" bgcolor="#FFFFFF" nowrap="nowrap"><div align="center" class="STYLE1">
              <div align="center">${fun.funName}</div>
            </div></td>
            <td height="20" bgcolor="#FFFFFF" nowrap="nowrap"><div align="center"><span class="STYLE1">${fun.funUrl}</span></div></td>
            <td height="20" bgcolor="#FFFFFF" nowrap="nowrap"><div align="center"><span class="STYLE1">${fun.funPid}</span></div></td>
            <td height="20" bgcolor="#FFFFFF" nowrap="nowrap"><div align="center"><span class="STYLE1">${fun.funTarget}</span></div></td>
